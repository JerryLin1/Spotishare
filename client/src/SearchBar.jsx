...
function SearchBar(props) {
    ...
    const expandSearchArea = () => {
        ...
        if (window.innerWidth <= 1200) {
            searchArea.style.cssText =
                "position: fixed !important; width: 100vw; height: 100%; top: 0; left: 0; background-color: rgba(25,25,25,0.75); align-items: center";
            searchBox.style.cssText = "width: 60%";
            ...
            searchArea.style.cssText =
                "position: fixed !important; width: 100vw; top: 0; left: 0; background-color: rgba(25,25,25,0.75); align-items: center";
            ...
            anime({
                targets: searchArea,
                height: ["40.5em", `${window.innerHeight / 16}em`],
                width: "100vw",
    ...
    const shrinkSearchArea = () => {
        ...
        if (window.innerWidth <= 1200) {
            ...
            searchArea.style.cssText = "width: 100%; align-items: start";
            ...
            anime({
                targets: searchArea,
                height: [`${window.innerHeight / 16}em`, "40.5em"],
    ...
    return (
        <div
            onClick={(e) => {
                // onClick event to close search area if it is visible and they did not click on the result list or input field
        ...
        >
            ...
            <div id="result-list">
                {searchResults.length === 0 ? (
                    <h1 style={{ textAlign: "center", width: "100%" }}>Search up some songs!</h1>
                ) : (
